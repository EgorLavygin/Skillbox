...
tables_quantity = store[goods['Стол']][0]['quantity']
tables_quantity += store[goods['Стол']][1]['quantity']
...
sofas_quantity = store[goods['Диван']][0]['quantity']
sofas_quantity += store[goods['Диван']][1]['quantity']
...
chairs_quantity = store[goods['Стул']][0]['quantity']
chairs_quantity += store[goods['Стул']][1]['quantity']
chairs_quantity += store[goods['Стул']][2]['quantity']
print('Стул -', chairs_quantity, 'шт, стоимость', sofas_cost, 'руб')
